...
const MarketDetail = () => import (
    "../components/market/flux_market_detail.vue"
);
const MarketPaymentBefore = () => import (
    "../components/market/flux_market_payment_before.vue"
);
const MarketPaymentAfter = () => import (
    "../components/market/flux_market_payment_after.vue"
);
const Article = () => import ("../views/article.vue");
const ArticleMain = () => import (
    "../components/article/flux_article_main.vue"
);
const ArticleDetail = () => import (
    "../components/article/flux_article_detaile.vue"
);
const Ranking = () => import ("../views/ranking.vue");
const Sales = () => import ("../views/sales.vue");
const Registry = () => import (
    "../components/market/flux_market_registration.vue"
);
const RegistryInfo = () => import (
    "../components/market/flux_market_registration_info.vue"
);
const RegistryEdit = () => import (
    "../components/market/flux_market_registration_edit.vue"
);
const Mypage = () => import ("../views/mypage.vue");
const MypageWishList = () => import (
    "../components/mypage/flux_mypage_wish.vue"
);
const MypageActivity = () => import (
    "../components/mypage/flux_mypage_activity.vue"
);
const MypageWithdrawal = () => import (
    "../components/mypage/flux_mypage_withdrawal.vue"
);
...
const ManagerMain = () => import (
    "../components/manager/flux_manager_main.vue"
);
const ManagerArticleMain = () => import ("../views/manager_article.vue");
const ManagerArticleUserList = () => import (
    "../components/manager/flux_manager_article_userlist.vue"
);
const ManagerArticlePost = () => import (
    "../components/manager/flux_manager_article_post.vue"
);
const ManagerArticleModify = () => import (
    "../components/manager/flux_manager_article_modify.vue"
);
const ManagerArticleView = () => import (
    "../components/manager/flux_manager_article_managerview.vue"
);
const ManagerUserMain = () => import ("../views/manager_user.vue");
const ManagerUserList = () => import (
    "../components/manager/flux_manager_userlist.vue"
);
const ManagerAdminList = () => import (
    "../components/manager/flux_manager_adminlist.vue"
);

const UseManagerNotice = () => import ("../views/manager_notice.vue");
const ManagerNoticeList = () => import (
    "../components/manager/flux_manager_notice_list.vue"
);
const ManagerNoticePost = () => import (
    "../components/manager/flux_manager_notice_post.vue"
);
const ManagerNoticeModify = () => import (
    "../components/manager/flux_manager_notice_modify.vue"
);
